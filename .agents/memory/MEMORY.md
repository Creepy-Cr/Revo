...
- [Dev schema drift](dev-schema-drift.md) — a seed failing on a column no schema file mentions is an unpushed drop; drizzle's data-loss prompt blocks non-interactive pushes.
